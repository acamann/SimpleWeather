...
type WeatherFontIconProps = Omit<ImageProps, "source"> & {
  conditionId?: number;
};

// Alternative Weather Icons from https://erikflowers.github.io/weather-icons/
const WeatherFontIcon: React.FC<WeatherFontIconProps> = (props: WeatherFontIconProps) => {
...
export default WeatherFontIcon;
